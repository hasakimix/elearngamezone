            ...
            <aside class="sidebar">
                ...
                <div class="module">
                    ...
                    <div class="module-content">
                        <ul>
                            <li><a href="#" data-target='content-html-output'>HTML Output From Web Server</a></li>
                            <li><a href="#" data-target='content-hello-world'>Hello, World!</a></li>
                            <li><a href="#" data-target='content-non-html-output'>Non-HTML Output From Web Server</a></li>
                            <li><a href="#" data-target='content-php-server'>PHP Build-in server</a></li>
                            <li><a href="#" data-target='content-php-cli'>PHP CLI</a></li>
                            <li><a href="#" data-target='content-instruction-separation'>Instruction Separation</a></li>
                            <li><a href="#" data-target='content-php-tags'>PHP Tags</a></li>
                        </ul>
                    </div>
                </div>
                <div class="module">
                ...
                <div class="module">
                    ...
                    <div class="module-content">
                        <ul>
                            <li><a href="#" data-target='content-superglobal'>Superglobal Variables</a></li>
                            <li><a href="#" data-target='content-static-properties'>Static Properties And Variables</a></li>
                            <li><a href="#" data-target='content-user-defined-global'>User-defined Global Variables</a></li>
                        </ul>
                    </div>
                </div>
                <!--<div class="module">
