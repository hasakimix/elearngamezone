    ...
    <aside class="sidebar">
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" data-target='content-Creating-Your-First-Java-Program'>Creating Your First Java Program</a></li>
                    <li><a class="topic" href="#" data-target='content-Numeric-primitive-casting'>Numeric primitive casting</a></li>
                    <li><a class="topic" href="#" data-target='content-Non-numeric-primitive-casting'>Non-numeric primitive casting</a></li>
                    <li><a class="topic" href="#" data-target='content-Object-casting'>Object casting</a></li>
                    <li><a class="topic" href="#" data-target='content-Testing if an-object-can be-cast using-instanceof'>Testing if an object can be cast using instanceof</a></li>
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-Using a setter-or getter to-implement a-constraint'> Using a setter or getter to implement a constraint</a></li>
                    <li><a class="topic" href="#" data-target='content-Why Use-Getters-and-Setters?'> Why Use Getters and Setters?</a></li>
                    <li><a class="topic" href="#" data-target='content-Adding-Getters-and-Setters'>Adding Getters and Setters</a></li>
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-Dereferencing'>Dereferencing</a></li>
                    <li><a class="topic" href="#" data-target='content-Instantiating-a-reference-type'>Instantiating a reference type</a></li>
                    <li><a class="topic" href="#" data-target='content-The javac command - getting started'>The 'javac' command - getting started</a></li>
                    <li><a class="topic" href="#" data-target='content-Compiling for a different version of Java'>Compiling for a different version of Java</a></li>
