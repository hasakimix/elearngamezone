...
<div class="main-content">
    ...
    <aside class="sidebar">
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    ...
                    <li><a class="topic" href="#" data-target='content-Doctypes'>Doctypes</a></li>
                    <li><a class="topic" href="#" data-target='content-Headings'>Headings</a></li>
                    <li><a class="topic" href="#" data-target='content-Paragraphs'>Paragraphs</a></li>
                    <li><a class="topic" href="#" data-target='content-Text Formatting'>Text Formatting</a></li>
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-Anchors-and-Hyperlinks'> Anchors and Hyperlinks</a></li>
                    <li><a class="topic" href="#" data-target='content-Lists'>Lists</a></li>
                    <li><a class="topic" href="#" data-target='content-Tables'>Tables</a></li>
                    <li><a class="topic" href="#" data-target='content-Comments'>Comments</a></li>
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-Classes-and-IDs'>Classes and IDs</a></li>
                    <li><a class="topic" href="#" data-target='content-Data Attributes'>Data Attributes</a></li>
                    <li><a class="topic" href="#" data-target='content-Linking Resources'>Linking Resources</a></li>
                    <li><a class="topic" href="#" data-target='content-Include JavaScript Code in HTML'>Include JavaScript Code in HTML</a></li>
