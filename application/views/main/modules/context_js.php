    ...
    <aside class="sidebar">
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" data-target='content-JavaScript-Where To'>JavaScript Where To</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Output'>JavaScript Output</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Statements'>JavaScript Statements</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Syntax'>JavaScript Syntax</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Comments'>JavaScript Comments</a></li>
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Variables'>JavaScript Variables</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Let'>JavaScript Let</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Const'>JavaScript Const</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Operators'>JavaScript Operators</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Arithmetic'>JavaScript Arithmetic</a></li>
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Data-Types'>JavaScript Data Types</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Assignment'>JavaScript Assignment</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Functions'>JavaScript Functions</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Objects'>JavaScript Objects</a></li>
                    <li><a class="topic" href="#" data-target='content-JavaScript-Object-Properties'>JavaScript Object Properties</a></li>
