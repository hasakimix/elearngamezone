    ...
    <aside class="sidebar">
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-creating-variables'>Creating variables and assigning values</a></li>
                    <li><a class="topic" href="#" data-target='content-bloxk-indentation'>Block Indentation</a></li>
                    <li><a class="topic" href="#" data-target='content-data-types'>Data types</a></li>
                    <li><a class="topic" href="#" data-target='content-collection-types'>Collection Types</a></li>
                    <li><a class="topic" href="#" data-target='content-python-gui'>IDLE - Python GUI</a></li>
                    <li><a class="topic" href="#" data-target='content-user-input'>User Input</a></li>
                    <li><a class="topic" href="#" data-target='content-modules-and-function'>Built in Modules and Functions</a></li>
                    <li><a class="topic" href="#" data-target='content-creating-module'>Creating a module</a></li>
                    <li><a class="topic" href="#" data-target='content-installation-python'>Installation of Python 2.7.x and 3.x</a></li>
                    <li><a class="topic" href="#" data-target='content-string-function'>String function - str() and repr()</a></li>
                    <li><a class="topic" href="#" data-target='content-installing-external'>Installing external modules using pip</a></li>
                    <li><a class="topic" href="#" data-target='content-help-utility'>Help Utility</a></li>
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-string-data-type'>String Data Type</a></li>
                    <li><a class="topic" href="#" data-target='content-set-data-types'>Set Data Types</a></li>
                    <li><a class="topic" href="#" data-target='content-numbers-data-type'>Numbers data type</a></li>
                    <li><a class="topic" ref="#" data-target='content-list-data-type'>List Data Type</a></li>
                    <li><a class="topic" href="#" data-target='content-dictionary-data-type'>Dictionary Data Type</a></li>
                    <li><a class="topic" href="#" data-target='content-tuple-data-type'>Tuple Data Type</a></li>
        ...
        <div class="module">
            ...
            <div class="module-content">
                <ul>
                    <li><a class="topic" href="#" data-target='content-how-Indentation-parsed'>How Indentation is Parsed</a></li>
                    <li><a class="topic" href="#" data-target='content-indentation-errors'>Indentation Errors</a></li>
...
b[2] = 'something else' # returns a TypeError</pre>
        ...
        <ul>
            <ul>Supports indexing; immutable; hashable if all its members are hashable</ul>
        </ul>
        <ul>
            <ul>
...
'Little Rock'</pre>
    ...
    <section id="content-python-gui" class="content" style="display: none;">
        ...
        <ul>
            ...
            <ul>
                <p>If you're on Windows, the default command is python. If you receive a "'python' is not recognized" error, the most likely cause is that Python's location is not in your system's PATH environment variable. This can be accessed by right-clicking on 'My Computer' and selecting 'Properties' or by navigating to 'System' through 'Control Panel'. Click on 'Advanced system settings' and then 'Environment Variables...'. Edit the PATH variable to include the directory of your Python installation, as well as the Script folder (usually C:\Python27;C:\Python27\Scripts). This requires administrative privileges and may require a restart.</p>
            </ul>

            <ul>
                <p>When using multiple versions of Python on the same machine, a possible solution is to rename one of the python.exe files. For example, naming one version python27.exe would cause python27 to become the Python command for that version.</p>
            </ul>

            <ul>
                <p>You can also use the Python Launcher for Windows, which is available through the installer and comes by default. It allows you to select the version of Python to run by using py -[x.y] instead of python[x.y]. You can use the latest version of Python 2 by running scripts with py -2 and the latest version of Python 3 by running scripts with py -3.</p>
            </ul>
            <li>
                <p>Debian/Ubuntu/MacOS</p>
            </li>
            <ul>
                <p>This section assumes that the location of the python executable has been added to the PATH environmen variable.</p>
            </ul>
            <ul>
                <p>If you're on Debian/Ubuntu/MacOS, open the terminal and type python for Python 2.x or python3 for Python 3.x.</p>
            </ul>
            <ul>
            ...
            <ul>
                <p>The default Python on Arch Linux (and descendants) is Python 3, so use python or python3 for Python 3.x and python2 for Python 2.x.</p>
            </ul>
            <li>
                <p>Other systems</p>
            </li>
            <ul>
                <p>Python 3 is sometimes bound to python instead of python3. To use Python 2 on these systems where it is installed, you can use python2.</p>
            </ul>
        </ul>
    </section>
