...
<div class="container">
    <div class="d-flex justify-content-between mb-3">
        <h1>Create  <span class="text-info">Client User</span></h1>
    </div>

    <form action="<?= base_url("admin/manage/users/save/create") ?>" method="POST" id="save-user-client-form">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="preview">Information:</label>
                    <textarea id="information" name="information" placeholder="Write a brief information..." rows="8"></textarea>
                </div>
                <div class="form-group">
                    <label for="preview">BIO:</label>
                    <textarea id="bio" name="bio" placeholder="Write a brief bio..." rows="8"></textarea>
                </div>
            </div>
        </div>
        <div class="d-flex">
            <button id="submit_button" type="submit" class="btn save-btn mx-5">Save User</button>
            <a href="<?= base_url("admin/manage/users") ?>"  class="btn save-btn mx-5 bg-dark">
                Cancel
            </a>
        </div>
    </form>
    ...
    $(document).ready(function(){
        $("#save-user-client-form").on("submit", function(e){
            ...
            if(password.trim().length <= 0){
                _this_swal_response("Password", "Password Is Required", "error");
                e.preventDefault();
                return;
            }
