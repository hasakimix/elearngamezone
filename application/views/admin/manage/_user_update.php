...
<div class="container">
    <div class="d-flex justify-content-between mb-3">
        <h1>Update  <span class="text-info">Client User</span></h1>
    </div>
    <form action="<?= base_url("admin/manage/users/save/update") ?>" method="POST" id="save-user-client-form">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea id="information" name="information" placeholder="Write a brief information..." rows="8"><?= $user["information"] ?></textarea>
                </div>
                <div class="form-group">
                    <label for="preview">BIO:</label>
                    <textarea id="bio" name="bio" placeholder="Write a brief bio..." rows="8"><?= $user["bio"] ?></textarea>
                </div>
            </div>
        </div>
        <div class="d-flex">
