...
<div class="container">
    <div class="d-flex justify-content-between mb-3">
        <h1>Create  <span class="text-info">Video</span></h1>
    </div>

    <form action="<?= base_url("admin/videos/save/create") ?>" method="POST" id="save-videos-form">
        <div class="form-group">
            ...
            <select class="form-select" id="library_id" name="library_id">
                ...
                <?php foreach ($libraries as $key => $value): ?>
                    <option value="<?= $value["library_id"] ?>"><?= $value["library_name"] ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" placeholder="Enter Video Name">
        </div>
        <div class="form-group">
            <label for="preview">Description:</label>
            <textarea id="description" name="description" placeholder="Write a brief description..." rows="4"></textarea>
        </div>
        <div class="form-group">
            <label>
                Video URL: <small class="text-info"></small>
            </label>
            <input type="text" id="video_url" name="video_url" placeholder="Enter Video URL">
        </div>
        <div class="d-flex">
