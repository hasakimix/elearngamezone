...
<div class="container">
    <div class="d-flex justify-content-between mb-3">
        <h1>Create  <span class="text-info">Module Topics</span></h1>
    </div>

    <form action="<?= base_url("admin/modules/save/create") ?>" method="POST" id="save-module-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="module_topic" name="module_topic" placeholder="Enter Image URL">
        </div>
        <div class="d-flex">
