...
<div class="container">
    <div class="d-flex justify-content-between mb-3">
        <h1>Create  <span class="text-info">Flashcard</span></h1>
    </div>

    <form action="<?= base_url("admin/flashcards/save/create") ?>" method="POST" id="save-flashcard-form">
        ...
        <div class="form-group">
            ...
            <textarea id="question" name="question" placeholder="Write a brief question..." rows="4"></textarea>
        </div>
        <div class="form-group">
            <label for="preview">Answer:</label>
            <textarea id="answer" name="answer" placeholder="Write a brief answer..." rows="4"></textarea>
        </div>
        <div class="d-flex">
